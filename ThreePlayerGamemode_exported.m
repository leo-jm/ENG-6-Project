classdef ThreePlayerGamemode_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function Hit1ButtonPushed(app, event)
            ...
            computer.calcHandValue;
            switch length(computer.hand)
                            case 3
                                app.CompHandImage3.ImageSource = computer.hand(3).image;
                                app.CompHandImage3.Visible = 'on';
                            case 4
                                app.CompHandImage4.ImageSource = computer.hand(4).image;
                                app.CompHandImage4.Visible = 'on';
                            case 5
                                app.CompHandImage5.ImageSource = computer.hand(5).image;
                                app.CompHandImage5.Visible = 'on';  
                end
        ...
        function StandButtonPushed(app, event)
            ...
            global cardDecks
            global deckDraw
            app.DealerHandImage2.ImageSource = dealer.hand(2).image;
            ...
            while dealer.handValue < 17
                ...
                switch length(dealer.hand)
                            case 3
                                app.DealerHandImage3.ImageSource = dealer.hand(3).image;
                                app.DealerHandImage3.Visible = 'on';
                            case 4
                                app.DealerHandImage4.ImageSource = dealer.hand(4).image;
                                app.DealerHandImage4.Visible = 'on';
                            case 5
                                app.DealerHandImage5.ImageSource = dealer.hand(5).image;
                                app.DealerHandImage5.Visible = 'on';  
                end
                % if cardDeck is empty then reshuffle
                % logical will equal an array of zeros unless .cards = 0
                % if .cards = 0 then an element will equal 1
            ...
            if (dealer.handValue > 21) & (AIbust == 1)               
                ...
                app.CompHandImage2.ImageSource = computer.hand(2).image;
