classdef Gamemode3_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            app.DealerHandDisplayLabel.Text = "Dealer's Hand: " + "0";
            app.CompHandDisplayLabel.Text = "Computer's Hand: " + "0";
        ...
        function StandButtonPushed(app, event)
            ...
            while dealer.handValue < 17
                ...
                app.DealerHandDisplayLabel.Text = " Your Hand: " + string(dealer.handValue)
                pause(1);
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Gamemode3_exported
